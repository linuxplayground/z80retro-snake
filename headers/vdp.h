 ...
 * c = Color, *buf = framebuffer
 * The framebuffer is a 0x600 char array of double pixels.
 *    0xLR where L is the left pixel and R is the right pixel.  See the TMS9900
 *    VDP Programmers guide for more details
 */
